...
- **排序**：只按公开价格升序。**不做主观打分，不接受付费改名次**——
  排序逻辑写死在代码里，没有人工干预的余地。
- **测速数据**：本清单**不提供任何测速数字**。行业里大量所谓「实测报告」是批量生成的，
  数字随机得毫无规律。与其看别人的截图，不如自己按
  [三天测试法](https://www.jichangyyds.com/blog/wangaofeng-ka-zenme-ban/)跑一遍。
